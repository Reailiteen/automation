import { Task, Schedule, ScheduledTask } from '../models/task';
import { 
  BaseAgent, 
  AgentOutput, 
  SchedulerInput, 
...
import { scheduleRepo, agentOutputRepo } from '../repos/task-repo';
import GeminiService from '../services/gemini';

export class SchedulerAgent implements BaseAgent<SchedulerInput, SchedulerOutput> {
  type = 'scheduler';

  async process(input: SchedulerInput): Promise<AgentOutput> {
